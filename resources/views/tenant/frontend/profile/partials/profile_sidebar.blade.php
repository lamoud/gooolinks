<div class="card card-navbar border-0 shadow-sm">
    @php
        $pageType = $pageType ?? 'te.profile.index';
    @endphp
    ...
    <li class="list-group-item {{ $pageType == 'te.profile.index' ? 'active' : ''}}">
        <a href="{{ route('te.profile.index') }}">
    ...
    {{-- <li class="list-group-item {{ $pageType == 'te.plans' ? 'active' : ''}}">
        <a href="{{ route('te.plans') }}">
    ...
    <li class="list-group-item {{ $pageType == 'te.profile.settings' ? 'active' : ''}}">
        <a href="{{ route('te.profile.settings') }}">
