    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light py-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('te.home') }}">
                    @if (get_setting('site_logo', '#') && file_exists(public_path(get_setting('site_logo', '#'))))
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('te.home') }}">الرئيسية</a>
                        </li>
                    </ul>
