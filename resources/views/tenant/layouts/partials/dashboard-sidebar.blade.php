<nav id="sidebar" class="">
    ...
    <div class="">
        @php
            $pg = isset($pageType) && $pageType ? $pageType : 'dashboard';
        @endphp
        <ul class="list-unstyled components mb-5">
            <li class="{{$pg == 'dashboard' ? 'active' : ''}}">
            ...
            <li class="{{$pg == 'admin.plans' ? 'active' : ''}}">
                ...
                <a href="{{route('admin.plans')}}">{{ __('Plans and Packages') }}</a>
            </li>
            <li>
