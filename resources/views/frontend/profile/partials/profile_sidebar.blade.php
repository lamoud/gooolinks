<div class="card card-navbar border-0 shadow-sm">
    @php
        $pageType = $pageType ?? 'profile.index';
    @endphp
    <div class="navbar-title">
        <b><small>{{ __('Hi :name', ['name' => Auth::user()->name]) }}</small></b>
    </div>
    <ul class="list-group list-group-flush border-0">

    <li class="list-group-item {{ $pageType == 'profile.index' ? 'active' : ''}}">
    ...
    <li class="list-group-item {{ $pageType == 'plans' ? 'active' : ''}}">
        <a href="{{ route('plans') }}">
            ...
            <span>{{ __('Plan and subscription') }}</span>
        </a>
    </li>

    <li class="list-group-item {{ $pageType == 'profile.settings' ? 'active' : ''}}">
