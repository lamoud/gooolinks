    ...
    <div class="">
        ...
        <ul class="list-unstyled components mb-5">
            <li>
                ...
                <a href="/" target="_plank">{{ __('Home') }}</a>
            </li>
            <li class="{{$pg == 'dashboard' ? 'active' : ''}}">
                ...
                <a href="{{route('dashboard')}}">الإحصاءات</a>
            </li>
            <li>
            ...
            <li class="{{$pg == 'admin.payments' ? 'active' : ''}}">
                ...
                <a href="{{route('admin.payments')}}">{{ __('Payments') }}</a>
            </li>
            <li class="{{$pg == 'admin.links' ? 'active' : ''}}">
                ...
                <a href="{{route('admin.links')}}">{{ __('Links') }}</a>
            </li>
            <li class="{{$pg == 'admin.stafroles' ? 'active' : ''}}">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
                <a href="{{route('admin.stafroles')}}">{{ __('Staff and Roles') }}</a>
            </li>
            
            <li class="{{$pg == 'admin.users' ? 'active' : ''}}">
            ...
            <li class="{{$pg == 'admin.settings' ? 'active' : ''}}">
